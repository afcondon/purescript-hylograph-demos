...
(() => {
  ...
  var strokeFor = function(f) {
    ...
    if (f.why instanceof ByRule) {
      ...
      ;
      throw new Error("Failed pattern match at Story (line 230, column 15 - line 235, column 30): " + [f.why.value0.rule.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Story (line 228, column 15 - line 235, column 30): " + [f.why.constructor.name]);
  };
  ...
  var fillFor = function(f) {
    ...
    if (f.why instanceof ByRule) {
      ...
      ;
      throw new Error("Failed pattern match at Story (line 220, column 15 - line 225, column 30): " + [f.why.value0.rule.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Story (line 218, column 13 - line 225, column 30): " + [f.why.constructor.name]);
  };
  var claimLabel = /* @__PURE__ */ (function() {
    ...
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Story (line 210, column 14 - line 212, column 54): " + [v.constructor.name]);
    };
  })();
  var chosenDag = /* @__PURE__ */ (function() {
    var isAmber = function(f) {
      ...
      ;
      throw new Error("Failed pattern match at Story (line 205, column 15 - line 207, column 21): " + [f.why.constructor.name]);
    };
    ...
    var v = minimumBy(foldableArray)(comparing(ordInt)(function($67) {
    ...
    ;
    throw new Error("Failed pattern match at Story (line 199, column 5 - line 203, column 58): " + [v.constructor.name]);
  })();
  var dagTree = /* @__PURE__ */ (function() {
    ...
    return elem2(SVG.value)([viewBox(0)(0)(width9)(height9), width8(width9), height8(height9)])(append10(edges)(nodes));
  })();
