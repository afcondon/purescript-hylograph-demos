...
(() => {
  ...
  var insert5 = /* @__PURE__ */ insert3(ordFactId);
      ...
      var collect2 = function(acc) {
        return function(fact) {
          if (member4(fact.id)(acc.needed)) {
            return {
              needed: foldl4(flip(insert5))(acc.needed)(premisesOf(fact)),
  ...
  var depthOf = function(kb) {
    var depth = function(depths) {
      return function(fact) {
        ...
        ;
        return 1 + foldl4(function(m) {
          return function(p2) {
            return max6(m)(fromMaybe(0)(lookup4(p2)(depths)));
          };
        })(0)(v) | 0;
      };
    };
    ...
    return foldl4(step3)(empty2)(facts(kb));
  };
  ...
  var insert6 = /* @__PURE__ */ insert(ordInt);
              ...
              if (otherwise) {
                ...
                var barycenters = mapFlipped2(currentNodes)(function(node) {
                  ...
                  var avg = (function() {
                    ...
                    ;
                    return foldl5(add2)(0)(parentPositions) / toNumber2(length(parentPositions));
                  })();
                  return new Tuple(avg, node);
                });
                var sorted = mapFlipped2(sortWith2(fst2)(barycenters))(snd2);
                var groups$prime = insert6(layer)(sorted)(groups);
          ...
          return function($copy_v1) {
            return function($copy_v2) {
              ...
              function $tco_loop(v, v1, v2) {
                ...
                var layers$prime = foldl5(function(acc) {
                  return function(n) {
                    var currentLayer = fromMaybe(0)(lookup14(n)(acc));
                    return insert13(n)(max7(currentLayer)(v1))(acc);
                  };
                })(v2)(v);
