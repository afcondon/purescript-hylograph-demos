...
(() => {
  ...
  // output/Hylograph.Music.Internal.FFI/foreign.js
  ...
  // output/Anscombe.Timer/index.js
  var setInterval3 = function(ms) {
    return function(action2) {
      return setInterval2(round2(ms))(action2);
    };
  };
  var clearInterval3 = clearInterval2;
  ...
  var noteEmitter = function(intervalMs) {
    return makeEmitter(function(emit) {
      return function __do2() {
        var intervalId = setInterval3(intervalMs)(emit(AdvanceNote.value))();
        return clearInterval3(intervalId);
      };
    });
  };
  ...
  var cycleEmitter = function(cycleDurationMs) {
    return makeEmitter(function(emit) {
      return function __do2() {
        var intervalId = setInterval3(cycleDurationMs)(emit(ScheduleNextCycle.value))();
        return clearInterval3(intervalId);
      };
    });
  };
