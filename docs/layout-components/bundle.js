...
(() => {
  ...
  var toSimpleGraph = function(dictOrd) {
    var fromFoldable12 = fromFoldable4(dictOrd);
    var fromFoldable22 = fromFoldable2(dictOrd)(foldableArray);
    return function(v) {
      var convertEntry = function(v1) {
        return new Tuple(v1.value0, fromFoldable12(map7(function(v2) {
          return v2.target;
        })(v1.value1)));
      };
      return {
        nodes: toUnfoldable4(v.nodeSet),
        edges: fromFoldable22(map7(convertEntry)(toUnfoldable1(v.forward)))
      };
    };
  };
  var outgoing = function(dictOrd) {
    ...
    return function(node) {
      return function(v) {
        return fromMaybe([])(lookup9(node)(v.forward));
      };
    };
  };
  var incoming = function(dictOrd) {
    ...
    return function(node) {
      return function(v) {
        return fromMaybe([])(lookup9(node)(v.reverse));
      };
    };
  };
  var empty4 = {
      ...
      return function(target5) {
        return function(weight) {
          return function(v) {
            ...
            return {
              nodeSet: insert8(source2)(insert8(target5)(v.nodeSet)),
              edgeList: snoc(v.edgeList)({
                source: source2,
                target: target5,
                weight
              }),
              forward: alter3(addToForward(target5)(weight))(source2)(v.forward),
              reverse: alter3(addToReverse(source2)(weight))(target5)(v.reverse)
            };
          };
        };
      };
  ...
  var sankeyNodeValue = function(v) {
    return max2(foldl4(add2)(0)(v.incoming))(foldl4(add2)(0)(v.outgoing));
  };
  ...
  var initialSankeyGraphModel = function(config2) {
    return {
      linkCount: 0,
      nodeCount: 0,
      nodeNameToID: empty2,
  ...
  var fromFoldable5 = /* @__PURE__ */ fromFoldable3(foldableArray)(ordNodeID);
  var outgoing2 = /* @__PURE__ */ outgoing(ordNodeID);
  var incoming2 = /* @__PURE__ */ incoming(ordNodeID);
  var initialiseSankeyNode = function(m) {
    return function(id3) {
      return bind2(lookup2(id3)(m.nodeIDToName))(function(name15) {
        var sourceLinks = fromFoldable5(map8(function(v) {
          return v.target;
        })(outgoing2(id3)(m.graph)));
        var targetLinks = fromFoldable5(map8(function(v) {
          return v.source;
  ...
  var defaultSankeyConfig = function(width8) {
  ...
  var snoc4 = function(cat) {
    return function(a2) {
      return append2(cat)(new CatCons(a2, empty7));
    };
  };
  ...
  var findBackEdges = function(dictOrd) {
    var lookup9 = lookup(dictOrd);
    var $$delete4 = $$delete2(dictOrd);
    var insert8 = insert2(dictOrd);
    var member5 = member2(dictOrd);
    var insert14 = insert2(ordTuple(dictOrd)(dictOrd));
    var fromFoldable22 = fromFoldable8(dictOrd);
    return function(graph) {
      var dfsClassify = function(state3) {
        return function(node) {
          var targets = (function() {
            var v = lookup9(node)(graph.edges);
            if (v instanceof Nothing) {
              return [];
            }
            ;
            ...
            ;
            throw new Error("Failed pattern match at Data.Graph.Algorithms (line 486, column 17 - line 488, column 39): " + [v.constructor.name]);
          })();
          var state$prime = {
            backEdges: state3.backEdges,
            black: state3.black,
            white: $$delete4(node)(state3.white),
            gray: insert8(node)(state3.gray)
          };
          var state$prime$prime = foldl2(function(st) {
            return function(target5) {
              var $300 = member5(target5)(st.gray);
              if ($300) {
                return {
                  gray: st.gray,
                  white: st.white,
                  black: st.black,
                  backEdges: insert14(new Tuple(node, target5))(st.backEdges)
                };
              }
              ;
              var $301 = member5(target5)(st.white);
              if ($301) {
                return dfsClassify(st)(target5);
              }
              ;
              return st;
            };
          ...
          return {
            ...
            gray: $$delete4(node)(state$prime$prime.gray),
            black: insert8(node)(state$prime$prime.black)
          };
        };
      };
      var initial = {
        white: fromFoldable22(graph.nodes),
        gray: empty3,
        black: empty3,
        backEdges: empty3
      };
      var result = foldl2(function(state3) {
        return function(node) {
          var $302 = member5(node)(state3.white);
          if ($302) {
  ...
  var union4 = /* @__PURE__ */ union2(ordNodeID);
  var fromFoldable9 = /* @__PURE__ */ fromFoldable3(foldableArray)(ordNodeID);
  var eq2 = /* @__PURE__ */ eq(eqLinkID);
  var fromFoldable1 = /* @__PURE__ */ fromFoldable2(ordNodeID)(foldableArray);
  var lookup13 = /* @__PURE__ */ lookup(ordNodeID);
  var mod2 = /* @__PURE__ */ mod(euclideanRingInt);
  var show2 = /* @__PURE__ */ show(showInt);
  var discard5 = /* @__PURE__ */ discard(discardUnit)(bindStateT2);
  var for_3 = /* @__PURE__ */ for_(applicativeStateT2)(foldableArray);
  var processCSVLink = function(link3) {
    return bind6(get2)(function(model) {
      ...
      return modify_3(function(v1) {
        ...
        $139.nodeIDToName = insert13(v.sid)(link3.s)(insert13(v.tid)(link3.t)(model.nodeIDToName));
        $139.nodeOrder = append5(model.nodeOrder)(v.newNodes);
                ...
                return function(height8) {
                  return function(padding1) {
                    var scaleForLayer = function(layerNodes) {
                      ...
                      var availableHeight = height8 - (numNodes - 1) * padding1;
                    ...
                    var scales = map23(scaleForLayer)(layers2);
  ...
  var initialiseSankeyNodes = /* @__PURE__ */ bind6(get2)(function(model) {
    var sankeyNodes = catMaybes(map23(initialiseSankeyNode(model))(model.nodeOrder));
            ...
            return function(y1) {
              var updateNodes = function(allNodes) {
                return function(updated) {
                  return map23(function(node) {
                    var v = find2(function(u2) {
                      return eq12(u2.node.index)(node.index);
                    })(updated);
                    if (v instanceof Just) {
                        ...
                        return function(py) {
                          var targetIncoming = sortBy(function(a2) {
                            return function(b2) {
                              var v = find2(function(n) {
                                return eq12(n.index)(b2.sourceIndex);
                              })(allNodes);
                              var v1 = find2(function(n) {
                                return eq12(n.index)(a2.sourceIndex);
                              })(allNodes);
                              if (v1 instanceof Just && v instanceof Just) {
                                return append12(compare3(v1.value0.y0)(v.value0.y0))(compare12(a2.index)(b2.index));
                              }
                              ;
                              return compare12(a2.index)(b2.index);
                            };
                          })(filter(function(l) {
                            return eq12(l.targetIndex)(target5.index);
                          })(allLinks));
                          var sourceOutgoing = sortBy(function(a2) {
                            return function(b2) {
                              var v = find2(function(n) {
                                return eq12(n.index)(b2.targetIndex);
                              })(allNodes);
                              var v1 = find2(function(n) {
                                return eq12(n.index)(a2.targetIndex);
                              })(allNodes);
                              if (v1 instanceof Just && v instanceof Just) {
                                return append12(compare3(v1.value0.y0)(v.value0.y0))(compare12(a2.index)(b2.index));
                              }
                            ...
                            return eq12(l.sourceIndex)(source2.index);
                          })(allLinks));
                          ...
                          var yAtTarget = foldl2(function(acc) {
                            return function(link3) {
                              ...
                              ;
                              var $164 = eq12(link3.sourceIndex)(source2.index);
                              if ($164) {
                                return {
                                  y: acc.y,
                                  found: true
                          ...
                          var yFinal = foldl2(function(acc) {
                            return function(link3) {
                              ...
                              ;
                              var $166 = eq12(link3.targetIndex)(target5.index);
                              if ($166) {
                                return {
                                  y: acc.y,
                                  found: true
                        ...
                        return function(py) {
                          ...
                          var yAtSource = foldl2(function(acc) {
                            return function(link3) {
                              ...
                              ;
                              var $176 = eq12(link3.targetIndex)(target5.index);
                              if ($176) {
                                return {
                                  y: acc.y,
                                  found: true
                          ...
                          var yFinal = foldl2(function(acc) {
                            return function(link3) {
                              ...
                              ;
                              var $178 = eq12(link3.sourceIndex)(source2.index);
                              if ($178) {
                                return {
                                  y: acc.y,
                                  found: true
                  ...
                  return function(allLinks) {
                    return function(padding1) {
                      var outgoingLinks = filter(function(l) {
                        return eq12(l.sourceIndex)(node.index);
                      })(allLinks);
                      ...
                      var result = foldl2(function(acc) {
                        return function(link3) {
                          var v = find2(function(n) {
                            return eq12(n.index)(link3.targetIndex);
                          })(allNodes);
                          if (v instanceof Just) {
                  ...
                  return function(allLinks) {
                    return function(padding1) {
                      var incomingLinks = filter(function(l) {
                        return eq12(l.targetIndex)(node.index);
                      })(allLinks);
                      var sortedLinks = sortBy(function(a2) {
                        return function(b2) {
                          var v = find2(function(n) {
                      ...
                      var result = foldl2(function(acc) {
                        return function(link3) {
                          var v = find2(function(n) {
                            return eq12(n.index)(link3.sourceIndex);
                          })(allNodes);
                          if (v instanceof Just) {
                        ...
                        return function(alpha) {
                          return function(beta) {
                            ...
                            var sortedLayerNodes = sortBy(function(a2) {
                              return function(b2) {
                                return compare3(a2.y0)(b2.y0);
                              };
                            })(layerNodes);
                            var layerNodeIndices = map23(function(v) {
                              return v.index;
                            })(sortedLayerNodes);
                            var nodesAfterRelax = foldl2(function(nodes1) {
                              return function(nodeIdx) {
                                var v = find2(function(n) {
                                  return eq12(n.index)(nodeIdx);
                                })(nodes1);
                                if (v instanceof Nothing) {
                                  return nodes1;
                                }
                                ...
                                if (v instanceof Just) {
                                  ...
                                  return map23(function(n) {
                                    var $213 = eq12(n.index)(nodeIdx);
                                    if ($213) {
                                      return updatedNode;
                                    }
                                    ;
                            ...
                            var sortedWithTarget = map23(function(node) {
                              return {
                                node,
                                targetY: node.y0
                              };
  ...
  var detectAndRemoveBackEdges = /* @__PURE__ */ bind6(get2)(function(model) {
  ...
  var computeNodeValues = /* @__PURE__ */ (function() {
    var setNodeValue2 = function(valueFn) {
      return function(links) {
        return function(n) {
          var outgoing3 = map23(function(v) {
            return v.value;
          })(filter(function(l) {
            return eq12(l.sourceIndex)(n.index);
          })(links));
          var incoming3 = map23(function(v) {
            return v.value;
          })(filter(function(l) {
            return eq12(l.targetIndex)(n.index);
          })(links));
          return {
            name: n.name,
            x0: n.x0,
    ...
    return bind6(get2)(function(model) {
      var allLinks = append5(model.sankeyLinks)(model.backEdgeLinks);
      var updatedNodes = map23(setNodeValue2(model.config.nodeValueStrategy)(allLinks))(model.sankeyNodes);
      return modify_3(function(v) {
        var $225 = {};
        for (var $226 in v) {
  ...
  var computeNodeHeights = /* @__PURE__ */ (function() {
      ...
      return function($copy_height) {
        return function($copy_current) {
          return function($copy_maxHeight) {
            ...
            var $tco_done = false;
            var $tco_result;
            function $tco_loop(nodes, height8, current, maxHeight) {
              if (isEmpty2(current)) {
                $tco_done = true;
                return nodes;
              }
              ;
              if (height8 > maxHeight) {
                $tco_done = true;
                return nodes;
              }
              ;
              if (otherwise) {
                var nodesWithHeight = map23(function(node) {
                ...
                $tco_var_height = height8 + 1 | 0;
                $tco_var_current = next;
                $copy_maxHeight = maxHeight;
                return;
              }
              ;
              throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 243, column 3 - line 243, column 84): " + [nodes.constructor.name, height8.constructor.name, current.constructor.name, maxHeight.constructor.name]);
            }
            ;
            while (!$tco_done) {
    ...
    return bind6(get2)(function(model) {
      ...
      var initialCurrent = fromFoldable9(map23(function(v) {
        return v.index;
      })(sinkNodes));
        ...
        return function($copy_current) {
          return function($copy_maxDepth) {
            ...
            function $tco_loop(nodes, depth, current, maxDepth) {
              ...
              ;
              if (otherwise) {
                var nodesWithDepth = map23(function(node) {
  ...
  var computeLinkBreadths = /* @__PURE__ */ (function() {
        ...
        var linksWithY0 = foldl2(function(currentLinks) {
          return function(node) {
            var outgoingLinks = filter(function(link3) {
              return eq12(link3.sourceIndex)(node.index);
            })(currentLinks);
            var sorted = sortBy(function(a2) {
              return function(b2) {
                var v = find2(function(n) {
            ...
            return map23(function(link3) {
              var v = find2(function(l) {
                return eq2(l.index)(link3.index);
              })(withY0.links);
              if (v instanceof Just) {
                return v.value0;
              }
        ...
        var linksWithY1 = foldl2(function(currentLinks) {
          return function(node) {
            var incomingLinks = filter(function(link3) {
              return eq12(link3.targetIndex)(node.index);
            })(currentLinks);
            var sorted = sortBy(function(a2) {
              return function(b2) {
                var v = find2(function(n) {
      ...
      return function(y0) {
        return function(y1) {
          return function(padding) {
            ...
            var scales = map23(scaleForLayer)(layers);
            var nonEmptyScales = filter(function(s) {
              return s > 0;
            })(scales);
            var v = head(nonEmptyScales);
    ...
    return bind6(get2)(function(model) {
      ...
      var linksWithWidth = map23(function(link3) {
        return {
          value: link3.value,
          color: link3.color,
          index: link3.index,
  ...
  var classifyBackEdges = function(nodes) {
    return function(backLinks) {
      ...
      ;
      var nodeLayerMap = fromFoldable1(map23(function(n) {
      ...
      var isEndCyclic = function(link3) {
        var tgtLayer = fromMaybe(-1 | 0)(lookup13(link3.targetIndex)(nodeLayerMap));
        var srcLayer = fromMaybe(-1 | 0)(lookup13(link3.sourceIndex)(nodeLayerMap));
  ...
  var assignColors = /* @__PURE__ */ bind6(get2)(function(model) {
    ...
    var nodesWithColor = mapWithIndex2(function(i2) {
      return function(node) {
        return {
          ...
          y0: node.y0,
          y1: node.y1,
          color: fromMaybe("#999")(index(colors)(mod2(i2)(length(colors))))
        };
      };
    })(model.sankeyNodes);
        ...
        return function(link3) {
          ...
          if (mode instanceof SourceTargetGradient) {
            return {
              ...
              y1: link3.y1,
              index: link3.index,
              color: "url(#sankey-gradient-" + (show2(link3.index) + ")")
            };
          }
          ;
    ...
    var linksWithColor = map23(assignLinkColor(nodesWithColor)(model.config.linkColorMode))(model.sankeyLinks);
    var backLinksWithColor = map23(assignLinkColor(nodesWithColor)(model.config.linkColorMode))(model.backEdgeLinks);
    return modify_3(function(v) {
      var $282 = {};
      for (var $283 in v) {
    ...
    return function(config2) {
      return function(x0) {
        return function(x1) {
          ...
          var nodesWithLayer = map23(function(node) {
            var layer = alignNodeToLayer(config2.alignment)(node)(numLayers);
            return {
              color: node.color,
              depth: node.depth,
              index: node.index,
          ...
          var kx = (x1 - x0 - config2.nodeWidth) / max1(1)(toNumber(numLayers - 1 | 0));
          var nodesWithX = map23(function(node) {
  ...
  var computeNodeBreadths = /* @__PURE__ */ bind6(get2)(function(model) {
  ...
  var computeLayoutWithConfig = function(linkInputs) {
    return function(config2) {
      var computeSankeyLayout = discard5(for_3(linkInputs)(processCSVLink))(function() {
      ...
      var finalModel = execState(computeSankeyLayout)(initialSankeyGraphModel(config2));
  ...
  var findNode = function(nodes) {
    return function(nodeId) {
      return find2(function(n) {
        return eq3(n.index)(nodeId);
      })(nodes);
    };
  };
  var generateLinkPath = function(nodes) {
    return function(link3) {
      var targetNode = findNode(nodes)(link3.targetIndex);
      var sourceNode = findNode(nodes)(link3.sourceIndex);
  ...
  var eqElementType = {
    eq: function(x) {
      return function(y) {
        ...
        ;
        if (x instanceof Text2 && y instanceof Text2) {
          return true;
        }
        ;
  ...
  var eq4 = /* @__PURE__ */ eq(eqElementType);
    ...
    var $lazy_flatten = $runtime_lazy9("flatten", "Hylograph.HATS", function() {
      return concatMap(function(t) {
        ...
        if (t instanceof Elem2) {
          var $46 = eq4(t.value0.elemType)(Group.value);
          if ($46) {
  ...
  var onCoordinatedHighlightWithTooltip = function(config2) {
    return new ThunkedCoordinatedHighlight({
      identify: function(v) {
        return config2.identify;
      },
      classify: config2.classify,
      group: config2.group,
      tooltipContent: map110(function(t) {
        return function(v) {
          return t.content;
        };
      })(config2.tooltip),
      tooltipTrigger: (function() {
        if (config2.tooltip instanceof Just) {
          return config2.tooltip.value0.showWhen;
        }
        ;
        if (config2.tooltip instanceof Nothing) {
          return OnHover.value;
        }
        ;
        throw new Error("Failed pattern match at Hylograph.HATS (line 663, column 21 - line 665, column 25): " + [config2.tooltip.constructor.name]);
      })(),
      tooltipBorderColor: bind7(config2.tooltip)(function(v) {
  ...
  var fromFoldable10 = /* @__PURE__ */ fromFoldable3(foldableArray)(ordString);
    ...
    return function(plainHandler) {
      return function(modifierHandler) {
        return function __do2() {
          ...
          addEventListener("click")(listener)(false)(toEventTarget2(el))();
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var baseDelay = fromMaybe(0)(map111(unwrap3)(phaseSpec.transition.value0.delay));
                  ...
                  return map25(catMaybes)(traverse2(mkUpdateTransition(el)(duration2)(delay)(easing))(templateAttrs));
                }
                ;
          ...
          return function(phaseSpec) {
            return function(idx) {
              ...
              if (phaseSpec.transition instanceof Just) {
                ...
                var delay = baseDelay + staggerDelay * toNumber(idx);
                var easing = toTickEasing(phaseSpec.transition.value0.easing);
                return map25(catMaybes)(traverse2(mkExitTransition(el)(duration2)(delay)(easing))(phaseSpec.attrs));
              }
              ;
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var delay = baseDelay + staggerDelay * toNumber(idx);
                  var easing = toTickEasing(phaseSpec.transition.value0.easing);
                  return map25(catMaybes)(traverse2(mkEnterTransition(duration2)(delay)(easing)(templateAttrs))(phaseSpec.attrs));
                }
                ;
                    ...
                    return function(datum) {
                      ...
                      if (itemTree instanceof Elem2) {
                        return function __do2() {
                          ...
                          return {
                            element: el,
                            childSelections: foldl2(union5)(empty2)(map24(function(v) {
                              return v.selections;
                            })(childMaps)),
                            transitions
                          };
            ...
            if (v instanceof MkFold) {
              return runSomeFold(v.value0)(function(foldSpec) {
                ...
                return function __do2() {
                  ...
                  var elements = map24(function(v1) {
                    return v1.element;
                  })(results);
                  var childMaps = foldl2(union5)(empty2)(map24(function(v1) {
                    return v1.childSelections;
                  })(results));
                  return {
                    selections: insert7(foldSpec.name)(elements)(childMaps),
                    entering: [catMaybes(map24(function(v1) {
            ...
            return function(v) {
              ...
              if (v instanceof MkFold) {
                return runSomeFold(v.value0)(function(spec) {
                  ...
                  var newKeys = fromFoldable10(map24(spec.keyFn)(items));
                  ...
                  return function __do2() {
                    ...
                    var existingKeys = fromFoldable10(map24(function(v1) {
                      return v1.key;
                    })(existingKeysAndEls));
                    ...
                    var updateElements = map24(function(v1) {
                      return v1.element;
                    })(filter(function(v1) {
                      return member4(v1.key)(updateKeys);
                    })(existingKeysAndEls));
                    var enterElements = map24(function(v1) {
                      return v1.element;
                    })(enterResults);
                    var childMaps = foldl2(union5)(empty2)(map24(function(v1) {
                      return v1.childSelections;
                    })(enterResults));
                    var selections = insert7(spec.name)(append7(updateElements)(enterElements))(childMaps);
    ...
    return function(tree) {
      return function __do2() {
        var doc = (function __do3() {
          var $235 = bind8(windowImpl)(document2)();
      ...
      var handleAction = function(v) {
        if (v instanceof Initialize2) {
          return bind9(get3)(function(state3) {
            return liftEffect7($$void8(rerender("#" + state3.containerId)(renderChart(state3.chart))));
          });
        }
        ;
        if (v instanceof Receive2) {
          return discard6(put2(v.value0))(function() {
            return liftEffect7($$void8(rerender("#" + v.value0.containerId)(renderChart(v.value0.chart))));
          });
        }
        ;
  ...
  // output/Hylograph.LayoutComponents.Sankey/index.js
  ...
  var Uniform = /* @__PURE__ */ (function() {
    ...
    ;
    Uniform2.value = new Uniform2();
    return Uniform2;
  })();
  var sankey = function(dictFoldable) {
    var fromFoldable12 = fromFoldable(dictFoldable);
    return function(input2) {
      var rows4 = fromFoldable12(input2.dataset);
      var fontSize = max8(9)(min6(13)(input2.theme.axisFontSize));
      var colorAt = function(i2) {
        var $31 = $$null(input2.theme.categoricalPalette);
        if ($31) {
          return input2.theme.markFill;
        }
        ;
        return fromMaybe(input2.theme.markFill)(index(input2.theme.categoricalPalette)(mod3(i2)(length(input2.theme.categoricalPalette))));
      };
      var positive = filter(function(r) {
        return input2.config.encoding.value(r) > 0;
      })(rows4);
      var links = map26(function(r) {
        return {
          s: input2.config.encoding.source(r),
          t: input2.config.encoding.target(r),
          v: input2.config.encoding.value(r)
        };
      })(positive);
      var rowFor = function(s) {
        return function(t) {
          return find2(function(r) {
            return input2.config.encoding.source(r) === s && input2.config.encoding.target(r) === t;
          })(positive);
        };
      };
      var touches = function(name15) {
        return function(hovered) {
          return any2(function(r) {
            return input2.config.encoding.source(r) === name15 && input2.config.encoding.target(r) === hovered || input2.config.encoding.target(r) === name15 && input2.config.encoding.source(r) === hovered;
          })(positive);
        };
      };
      ...
      var layoutConfig = (function() {
        var v = defaultSankeyConfig(innerW)(innerH);
        return {
          extent: v.extent,
          linkColorMode: v.linkColorMode,
          nodeValueStrategy: v.nodeValueStrategy,
          alignment: input2.config.alignment,
          nodeWidth: input2.config.nodeWidth,
          nodePadding: input2.config.nodePadding,
          iterations: input2.config.iterations
        };
      })();
      var result = computeLayoutWithConfig(links)(layoutConfig);
      var nameOf = function(ix) {
        return map112(function(v) {
          return v.name;
        })(findNode(result.nodes)(ix));
      };
      var nodeColors = fromFoldable11(mapWithIndex2(function(i2) {
        return function(n) {
          return new Tuple(n.name, colorAt(i2));
        };
      })(result.nodes));
      var colorOf = function(name15) {
        return fromMaybe(input2.theme.markFill)(lookup8(name15)(nodeColors));
      };
      var mkLink = function(link3) {
        return bind10(nameOf(link3.sourceIndex))(function(sourceName) {
          return bind10(nameOf(link3.targetIndex))(function(targetName) {
            var row = rowFor(sourceName)(targetName);
            var identify = (function() {
              if (row instanceof Just) {
                return input2.config.encoding.key(row.value0);
              }
              ;
              if (row instanceof Nothing) {
                return sourceName + ("->" + targetName);
              }
              ;
              throw new Error("Failed pattern match at Hylograph.LayoutComponents.Sankey (line 223, column 20 - line 225, column 54): " + [row.constructor.name]);
            })();
            var fill = (function() {
              if (input2.config.linkColor instanceof FromSource) {
                return colorOf(sourceName);
              }
              ;
              if (input2.config.linkColor instanceof FromTarget) {
                return colorOf(targetName);
              }
              ;
              if (input2.config.linkColor instanceof Uniform) {
                return input2.theme.markFill;
              }
              ;
              throw new Error("Failed pattern match at Hylograph.LayoutComponents.Sankey (line 229, column 16 - line 232, column 36): " + [input2.config.linkColor.constructor.name]);
            })();
            var content3 = (function() {
              if (row instanceof Just) {
                return input2.config.encoding.tooltip(row.value0);
              }
              ;
              if (row instanceof Nothing) {
                return sourceName + (" \u2192 " + targetName);
              ...
              ;
              throw new Error("Failed pattern match at Hylograph.LayoutComponents.Sankey (line 226, column 19 - line 228, column 55): " + [row.constructor.name]);
            })();
            var classify = function(hovered) {
              var $37 = hovered === identify;
              if ($37) {
                return Primary.value;
              }
              ;
              var $38 = hovered === sourceName || hovered === targetName;
              if ($38) {
            ...
            return pure13(withBehaviors([onCoordinatedHighlightWithTooltip({
              identify,
              classify,
            ...
            })])(elem2(Path.value)([staticStr("d")(generateLinkPath(result.nodes)(link3)), staticStr("fill")(fill), staticNum("fill-opacity")(input2.config.linkOpacity), staticStr("stroke")("none"), staticStr("class")("sankey-link")])([])));
          });
        });
      };
      var ribbons = mapMaybe(mkLink)(result.links);
      var mkNode = function(node) {
        var w = node.x1 - node.x0;
        var pastMiddle = node.x0 > innerW / 2;
        var h = node.y1 - node.y0;
        var label5 = elem2(Text2.value)([staticNum("x")((function() {
          if (pastMiddle) {
            return node.x0 - 6;
          }
          ;
          return node.x1 + 6;
        })()), staticNum("y")(node.y0 + h / 2 + fontSize / 3), staticStr("text-anchor")((function() {
          if (pastMiddle) {
            return "end";
          }
          ;
          return "start";
        })()), staticNum("font-size")(fontSize), staticStr("fill")(input2.theme.axisTextColor), staticStr("font-family")(input2.theme.fontFamily), staticStr("pointer-events")("none"), staticStr("textContent")(node.name), staticStr("class")("sankey-node-label")])([]);
        var fill = colorOf(node.name);
        var classify = function(hovered) {
          var $41 = hovered === node.name;
          if ($41) {
            return Primary.value;
          }
          ;
          var $42 = touches(node.name)(hovered);
          if ($42) {
            return Related.value;
          }
          ;
        ...
        var rect = withBehaviors([onCoordinatedHighlightWithTooltip({
          identify: node.name,
          classify,
          group: input2.config.highlightGroup,
          tooltip: new Just({
            content: node.name + (": " + show4(node.value)),
            showWhen: OnHover.value,
            borderColor: Nothing.value
          })
        })])(elem2(Rect.value)([staticNum("x")(node.x0), staticNum("y")(node.y0), staticNum("width")(w), staticNum("height")(h), staticStr("fill")(fill), staticStr("class")("sankey-node")])([]));
        var $43 = input2.config.showLabels && h >= input2.config.labelMinHeight;
        if ($43) {
      ...
      var nodes = map26(mkNode)(result.nodes);
      return elem2(SVG.value)([staticNum("width")(input2.config.layout.width), staticNum("height")(input2.config.layout.height), staticStr("class")("sankey"), staticStr("style")("background:" + input2.theme.background)])([elem2(Group.value)([staticStr("transform")("translate(" + (show4(input2.config.layout.margin.left) + ("," + (show4(input2.config.layout.margin.top) + ")"))))])([siblings(append13(ribbons)(nodes))])]);
    };
  };
  var frame = function(dictMonadAff) {
    var mkFrame2 = mkFrame(dictMonadAff);
    return function(dictFoldable) {
      return mkFrame2(sankey(dictFoldable));
    };
  };
  var config = function(enc) {
    return {
      ...
      encoding: {
        ...
        value: enc.value,
        key: function(row) {
          return enc.source(row) + ("->" + enc.target(row));
        },
        tooltip: function(row) {
          return enc.source(row) + (" \u2192 " + (enc.target(row) + (": " + show4(enc.value(row)))));
        }
      },
  ...
  // output/Demo.LayoutComponents.Main/index.js
  ...
  var frame2 = /* @__PURE__ */ frame(monadAffAff)(foldableArray);
  ...
  var mkInput = function(containerId) {
    return function(cfg) {
  ...
  var baseConfig = /* @__PURE__ */ (function() {
    ...
    return {
      ...
      nodeWidth: c0.nodeWidth,
      nodePadding: c0.nodePadding,
      iterations: c0.iterations,
      linkColor: c0.linkColor,
      linkOpacity: c0.linkOpacity,
      showLabels: c0.showLabels,
      labelMinHeight: c0.labelMinHeight,
      layout: {
        margin: c0.layout.margin,
        width: 900,
        height: 460
      },
      highlightGroup: new Just("energy"),
      encoding: {
        source: c0.encoding.source,
        target: c0.encoding.target,
        value: c0.encoding.value,
        key: c0.encoding.key,
        tooltip: function(r) {
          return r.from + (" \u2192 " + (r.to + (": " + (show5(r.amount) + " units"))));
        }
      }
    };
  })();
  var justifyInput = /* @__PURE__ */ mkInput("sankey-justify")(baseConfig)(defaultTheme);
  var leftInput = /* @__PURE__ */ (function() {
    return mkInput("sankey-left")({
      encoding: baseConfig.encoding,
      highlightGroup: baseConfig.highlightGroup,
      nodeWidth: baseConfig.nodeWidth,
      nodePadding: baseConfig.nodePadding,
      iterations: baseConfig.iterations,
      linkColor: baseConfig.linkColor,
      linkOpacity: baseConfig.linkOpacity,
      showLabels: baseConfig.showLabels,
      labelMinHeight: baseConfig.labelMinHeight,
      alignment: Left2.value,
      layout: {
        margin: baseConfig.layout.margin,
        width: 440,
        height: 340
      }
    })(defaultTheme);
  })();
  var rightInput = /* @__PURE__ */ (function() {
    return mkInput("sankey-right")({
      encoding: baseConfig.encoding,
      highlightGroup: baseConfig.highlightGroup,
      nodeWidth: baseConfig.nodeWidth,
      nodePadding: baseConfig.nodePadding,
  ...
  var targetColorInput = /* @__PURE__ */ (function() {
    return mkInput("sankey-target")({
      layout: baseConfig.layout,
      encoding: baseConfig.encoding,
      highlightGroup: baseConfig.highlightGroup,
      alignment: baseConfig.alignment,
      nodeWidth: baseConfig.nodeWidth,
      nodePadding: baseConfig.nodePadding,
      iterations: baseConfig.iterations,
      linkOpacity: baseConfig.linkOpacity,
      showLabels: baseConfig.showLabels,
      labelMinHeight: baseConfig.labelMinHeight,
      linkColor: FromTarget.value
    })(defaultTheme);
  })();
  var thinInput = /* @__PURE__ */ (function() {
    return mkInput("sankey-thin")({
      layout: baseConfig.layout,
      encoding: baseConfig.encoding,
      highlightGroup: baseConfig.highlightGroup,
      alignment: baseConfig.alignment,
  ...
  var uniformInput = /* @__PURE__ */ (function() {
    return mkInput("sankey-uniform")({
      layout: baseConfig.layout,
      encoding: baseConfig.encoding,
      highlightGroup: baseConfig.highlightGroup,
      alignment: baseConfig.alignment,
  ...
  var rootComponent = /* @__PURE__ */ (function() {
    ...
    return mkComponent({
      ...
      render: function(v) {
        return div2([style("font-family: Inter, Helvetica, sans-serif; padding: 32px; max-width: 1400px; margin: 0 auto;")])([h1([style("font-size: 20px; font-weight: 500; margin: 0 0 8px; color: #111;")])([text5("hylograph-layout-components")]), p([style("font-size: 13px; color: #666; margin: 0 0 32px;")])([text5("Charts whose geometry comes from a layout algorithm rather than from scale arithmetic. Same Config / Encoding / Theme / Frame shape as hylograph-components \u2014 the sibling library changes where the coordinates come from, not how you ask for a chart.")]), h2([sectionStyle])([text5("Sankey")]), p([subStyle])([text5("One row of the dataset is one link: a source, a target, a quantity. Nodes are whatever names the links mention \u2014 the caller never declares them. Positions and ribbon geometry come from DataViz.Layout.Sankey; node colour comes from Theme.categoricalPalette, replacing the layout's own assignment so a Sankey sits beside a BarChart without a palette clash.")]), p([subStyle])([text5("Hover a node: its ribbons go Primary and its neighbours go Related, everything else Dimmed. Hover a ribbon: both its endpoints light up. That three-way classification is what a Sankey is for, and it is the same coordinated-highlight machinery the bar charts use.")]), slot_1($$Proxy.value)(unit)(frame2)(justifyInput), div2([style("height: 48px;")])([]), h2([sectionStyle])([text5("alignment")]), p([subStyle])([text5('Where nodes sit when they have slack. Justify (above) spreads them across the full width. Left packs each node as early as its dependencies allow; Right packs them as late as possible, which reads as "work backwards from the sinks".')]), div2([style("display: grid; grid-template-columns: 1fr 1fr; gap: 24px;")])([div_([h3([subHeadStyle])([text5("alignment: Left")]), slot_22($$Proxy.value)(unit)(frame2)(leftInput)]), div_([h3([subHeadStyle])([text5("alignment: Right")]), slot_3($$Proxy.value)(unit)(frame2)(rightInput)])]), div2([style("height: 48px;")])([]), h2([sectionStyle])([text5("linkColor")]), p([subStyle])([text5('Which end of a ribbon gives it its colour. FromSource (above) reads as "where did this come from"; FromTarget reads as "where is this going", which is the better choice when the interesting question is at the sinks. Uniform drops to Theme.markFill and lets the nodes carry all the colour.')]), h3([subHeadStyle])([text5("linkColor: FromTarget")]), slot_4($$Proxy.value)(unit)(frame2)(targetColorInput), div2([style("height: 32px;")])([]), h3([subHeadStyle])([text5("linkColor: Uniform")]), slot_5($$Proxy.value)(unit)(frame2)(uniformInput), div2([style("height: 48px;")])([]), h2([sectionStyle])([text5("nodeWidth and nodePadding")]), p([subStyle])([text5("The two knobs that decide how much of the frame is flow and how much is furniture. Thin nodes with generous padding put the emphasis on the ribbons; the defaults (15 and 10) match d3-sankey, so a diagram drawn here lands where d3 would put it.")]), slot_6($$Proxy.value)(unit)(frame2)(thinInput)]);
      },
      "eval": mkEval(defaultEval)
    });
  })();
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind11(awaitBody)(function(body2) {
    return bind11(runUI2(rootComponent)(unit)(body2))(function() {
      return pure14(unit);
    });
  }));
